/**
 * DualView - Landscape i18n
 * Version: 0.4.2
 *
 * Traductions FR/EN et helpers d'application.
...
const I18N = {
    fr: {
        ...
        resize: 'Redimensionner', settings: 'Paramètres', history: 'Historique',
    ...
    en: {
        ...
        resize: 'Resize', settings: 'Settings', history: 'History',
